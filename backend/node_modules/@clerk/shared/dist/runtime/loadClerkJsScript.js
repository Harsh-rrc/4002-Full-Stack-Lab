...
const require_versionSelector = require('./versionSelector-D31OXlbt.js');
...
const clerkUIScriptUrl = (opts) => {
	...
	return `https://${buildScriptHost({
		...
		proxyUrl,
		domain
	})}/npm/@clerk/ui@${require_versionSelector.versionSelector(__internal_clerkUIVersion, "1.5.1")}/dist/ui.browser.js`;
};
